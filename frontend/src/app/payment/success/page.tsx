	...
	return (
		<div className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-4 text-center">
			...
			<p className="mt-2 text-sm text-gray-600">
				Your payment was successful. Please use the token below to collect your food.
			</p>

			{/* Token Card */}
			<div className="mt-6 w-full rounded-xl border border-green-300 bg-green-50 p-4">
				<div className="mb-2 text-sm text-gray-700">Order ID</div>
				<div className="mb-4 font-mono text-lg font-semibold">{orderId}</div>

				<div className="mb-2 text-sm text-gray-700">Your Token Number</div>
				<div className="text-3xl font-bold text-green-800">{tokenNumber}</div>
